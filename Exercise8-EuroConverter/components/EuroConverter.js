    ...
    <View style={{
      ...
      <View 
        ...
        <Picker
         ...
         onValueChange={(pickedCurrency, itemIndex) => setPickedCurrency(pickedCurrency)}>
        { 
           keys.map( (keys) => {
              return <Picker.Item label={keys} value={keys}/>
           })
        }
        </Picker>
      ...
      <View 
        ...
        <Button title='Convert' onPress={calculate}></Button>
      </View>
